...
activities = {
    ...
    "Basketball Team": {
        "description": "Develop basketball skills and teamwork through training and games",
...
def unregister_participant_via_query(activity_name: str, email: str):
    """Backward-compatible unregister route using the email query parameter."""
